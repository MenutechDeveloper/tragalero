...
async def verify():
    async with async_playwright() as p:
        ...
        try:
            ...
            await page.screenshot(path="final_adminCustomer_v5.png")
        except Exception as e:
            print(f"adminCustomer.html failed to show #app. Current URL: {page.url}")
            await page.screenshot(path="failed_adminCustomer_v5.png")
        ...
        try:
            ...
            await page.screenshot(path="final_adminWeb_v5.png")
            ...
            await page.screenshot(path="failed_adminWeb_v5.png")
