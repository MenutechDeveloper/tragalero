...
async def verify():
    async with async_playwright() as p:
        ...
        # Mock public.usuarios - Using Admin with capital A and role with capital A
        ...
        visible_app = await page.evaluate("document.getElementById('app').style.display != 'none'")
        print(f"adminCustomer #app display not none: {visible_app}")

        await page.screenshot(path="final_check_adminCustomer_v11.png")
        ...
        await page.screenshot(path="final_check_adminWeb_v11.png")
