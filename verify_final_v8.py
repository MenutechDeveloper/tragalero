...
async def verify():
    async with async_playwright() as p:
        ...
        try:
            ...
            await page.screenshot(path="final_adminCustomer_v8.png")
            ...
            await page.screenshot(path="failed_adminCustomer_v8.png")
        ...
        try:
            ...
            await page.screenshot(path="final_adminWeb_v8.png")
            ...
            hidden_elements = await page.evaluate("Array.from(document.querySelectorAll('.hidden')).map(el => el.id)")
            print(f"Hidden elements: {hidden_elements}")
            await page.screenshot(path="failed_adminWeb_v8.png")
